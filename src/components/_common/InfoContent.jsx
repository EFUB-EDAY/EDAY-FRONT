...
// link: 초록색 a 태그에 연결할 url, 링크가 아니라면 생략하면 됨

// 그 외는 디폴트값으로 아무것도 타입으로 넘겨주지 않아도 된다.
// ①②③④⑤ (동그라미 안 숫자) 는 그냥 텍스트에 포함시켜서 넣으면 된다.
// BodyBox들어가면 예시 들어놓았음. (info/1)

const InfoContent = ({ text, type, noMargin, NoRightMargin, link }) => {
    ...
    return (
        ...
        >
            {!link ? (
                ...
                <a href={link} target='_blank' style={{ color: '#369149' }}>
                    {text}
                </a>
            )}
        </div>
